   ...
   enum EnRouteCondition
     {
      ...
      CONDITION_WEEKDAY             =5,       // day of week 0 - воскресение
      ...
      CONDITION_DEALER              =9,       // dealer processed specified order or position
      //--- client data
      ...
      CONDITION_LAST                =CONDITION_POSITION_AVERAGE_TIME
     };
   //--- compare method
   ...
   enum EnRouteFlags
     {
      ...
      REQUEST_DEALER_POS_MODIFY|REQUEST_DEALER_ORD_MODIFY | REQUEST_DEALER_ORD_REMOVE | REQUEST_DEALER_ORD_ACTIVATE | REQUEST_DEALER_ORD_SLIMIT,
      //--- enumeration borders
   ...
   enum EnRouteAction
     {
      ...
      ACTION_LAST                   =ACTION_CONFIRM_MARKET
     };
   //--- common methods
   virtual void      Release(void)=0;
