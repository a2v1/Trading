...
public:
   ...
   enum EnCalcMode
     {
      ...
      TRADE_MODE_EXCH_LAST    =TRADE_MODE_EXCH_OPTIONS_MARGIN,
      //--- enumeration borders
      TRADE_MODE_FIRST        =TRADE_MODE_FOREX,
      TRADE_MODE_LAST         =TRADE_MODE_EXCH_OPTIONS_MARGIN
     };
   ...
   //--- margin check modes
   enum EnMarginCheckMode
     {
      MARGIN_CHECK_NORMAL     =0,  // standard check mode
      MARGIN_CHECK_ON_PROCESS =1,  // check margin after dealer confirmation
      //--- enumeration borders
      MARGIN_CHECK_FIRST      =MARGIN_CHECK_NORMAL,
      MARGIN_CHECK_LAST       =MARGIN_CHECK_ON_PROCESS
     };
   ...
   enum EnTradeFlags
     {
      ...
      //--- flags borders
      TRADE_FLAGS_ALL         =TRADE_FLAGS_PROFIT_BY_MARKET
     };
   //--- Margin Rate Types
