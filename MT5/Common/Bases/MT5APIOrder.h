   ...
   enum EnOrderActivation
     {
      ...
      ACTIVATION_LAST          =ACTIVATION_EXPIRATION
     };
   ...
   enum EnOrderReason
     {
      ...
      ORDER_REASON_TRANSFER    =12,      // order placed due position transfer
      //--- enumeration borders
      ORDER_REASON_FIRST       =ORDER_REASON_CLIENT,
      ORDER_REASON_LAST        =ORDER_REASON_TRANSFER
     };
