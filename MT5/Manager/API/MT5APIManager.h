...
//| Manager API version                                              |
//+------------------------------------------------------------------+
#define MTManagerAPIVersion  1377
#define MTManagerAPIDate     L"20 Jul 2016"
//+------------------------------------------------------------------+
//| Proxy description                                                |
//+------------------------------------------------------------------+
#pragma pack(push,1)
...
public:
                     CMTManagerAPIFactory(void) : m_hmodule(NULL),m_mtversion(NULL),m_mtmanager(NULL),m_mtadmin(NULL) {}
...
//--- check result
   if(m_hmodule && m_mtversion && m_mtmanager && m_mtadmin)
      res=MT_RET_OK;
   else
...
//--- check members & parameters
   if(!m_hmodule || !m_mtmanager)
      return(MT_RET_ERROR);
//--- create manager
   return(m_mtmanager(version,manager));
  }
//+------------------------------------------------------------------+
...
//--- check parameters
   if(!admin)
      return(MT_RET_ERR_PARAMS);
//--- check members & parameters
   if(!m_hmodule || !m_mtadmin)
      return(MT_RET_ERROR);
//--- create manager
   return(m_mtadmin(version,admin));
  }
//+------------------------------------------------------------------+
//| Version                                                          |
//+------------------------------------------------------------------+
