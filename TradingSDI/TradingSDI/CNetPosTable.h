	...
	COLUMN_ENTRY_LENGTH_STATUS(10,  m_Balance, m_dwBalanceLength, m_dwBalanceStatus)
	COLUMN_ENTRY_LENGTH_STATUS(11,  m_LastUpdate, m_dwLastUpdateLength, m_dwLastUpdateStatus)		
	COLUMN_ENTRY_LENGTH_STATUS(12,  m_Client_Group, m_dwClient_GroupLength, m_dwClient_GroupStatus)
	COLUMN_ENTRY_LENGTH_STATUS(13,  m_Client_Group1, m_dwClient_Group1Length, m_dwClient_Group1Status)		
	COLUMN_ENTRY_LENGTH_STATUS(14,  m_Client_Group2, m_dwClient_GroupL2ength, m_dwClient_GroupS2tatus)
	COLUMN_ENTRY_LENGTH_STATUS(15,  m_Type, m_dwTypeLength, m_dwTypeStatus)
